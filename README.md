# Exosuit MultiSelect
![Exosuit MultiSelect](assets/banner.png)
...
1. Close the game. Download the mod ZIP from [Releases](https://github.com/Toritte/ExosuitMultiSelect/releases).
2. Import the loader ZIP and `Exosuit-MultiSelect-v0.3.zip` into Arsenal or HD2MM; enable both and deploy.
